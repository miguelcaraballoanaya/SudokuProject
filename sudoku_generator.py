...
class Cell:
    ...
    def draw(self):
        ...
        if self.value != 0:
            ...
            sketched_font = pygame.font.Font(None, 80)
            sketched_text = sketched_font.render("", True, (128, 128, 128)) #grey color
            self.screen.blit(sketched_text, (x + self.width // 2 - sketched_text.get_width() // 2, y + self.height // 2 - sketched_text.get_height() // 2))
